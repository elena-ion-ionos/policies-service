module github.com/ionos-cloud/policies-service
...
require (
	...
	github.com/ionos-cloud/go-paaskit v0.115.0
...
require (
	...
	github.com/ionos-cloud/apis v0.0.0-20250902072407-450797a52f10 // indirect
